<template>
  <nav class="fixed top-0 left-0 w-full z-20 transition duration-200 bg-primary-200">
    <div class="container flex items-center justify-between h-20">
      <div class="relative z-30 flex items-center gap-2 mb-2 lg:mb-0">
        <h1 class="text-white font-bold text-lg lg:text-2xl">
      ...
      <div class="flex lg:hidden items-center gap-2">
        <button
          class="relative z-30 px-4 py-2 -mt-1.5 text-sm rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto"
        >
          Donate</button
        ><button class="relative z-30 text-white -mt-2 p-2">
          <svg
            width="18"
            height="12"
            viewBox="0 0 18 12"
      ...
      <div
        class="absolute lg:static top-20 inset-x-0 flex flex-col lg:flex-row items-center gap-5 lg:gap-10 bg-primary-200 lg:bg-transparent pt-5 pb-10 px-5 lg:p-0 transition duration-500 lg:duration-200 lg:-translate-y-0 translate-y-[-150%]"
      >
        ...
        ><a class="text-white font-medium" href="#trick-or-treat"
          >Trick or Treat</a
        ><button
          class="hidden md:block px-8 py-3 rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto"
        >
          Donate
        </button>
      </div>
