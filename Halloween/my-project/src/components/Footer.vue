<template>
  <footer>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28 mx-16">
      <div>
        ...
        <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">
        ...
        <div class="flex justify-end md:justify-start -mt-7 md:mt-3">
          <img
            class="w-12 md:-translate-x-10 scale-x-[-1] md:scale-100"
            src="../assets/footer2-img.bfd91188.webp"
            alt=""
          />
        </div>
      </div>
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center gap-12 text-white"
      >
        <div>
    ...
    <div class="grid place-items-center my-20 w-full">
      <div class="flex items-center gap-10">
        <a
          href="#"
          class="bg-secondary h-12 w-12 grid place-items-center rounded-md"
          ><img src="../assets/fb.15105bc3.svg" alt="" /></a
        ><a
          href="#"
          class="bg-secondary h-12 w-12 grid place-items-center rounded-md"
          ><img src="../assets/instagram.ef4f3b4c.svg" alt="" /></a
        ><a
          href="#"
          class="bg-secondary h-12 w-12 grid place-items-center rounded-md"
          ><img src="../assets/twitter.8b5b7743.svg" alt=""
        /></a>
      </div>
      <p
        class="md:text-lg font-medium text-center text-white mt-8 tracking-wider"
      >
        © Copyright, Halloweend 2021, All rights reserved.
      </p>
    </div>
  </footer>
</template>
